...
public class GradesApplication {
    public static void main(String[] args) {
        ...
        randyGrades.add(90.);
        randyGrades.add(90.);
        Student randy = new Student("Randy \"Mach Man\" Savage", randyGrades, "OhYeahBrother");
...
//        TERMINAL SCANNER ---------->
        ...
        System.out.println("Enter one of the usernames to find out more about that wrestler (to exit, enter \"X\"): ");
        ...
        while (true) {
            if (userInput.toLowerCase().equals("naturewoo")) {
                ...
                if (userInput2.toLowerCase().equals("yes")) {
                    main(args);
                } else {
            ...
            if (userInput.toLowerCase().equals("stunningsteve316")) {
                ...
                if (userInput3.toLowerCase().equals("yes")) {
                    main(args);
                } else {
                    System.out.println("1....2....3! IT'S OVER!");
                    return;
            ...
            if (userInput.toLowerCase().equals("ifyasmell")) {
                ...
                if (userInput4.toLowerCase().equals("yes")) {
                    main(args);
                } else {
                    System.out.println("1....2....3! IT'S OVER!");
                    return;
            ...
            if (userInput.toLowerCase().equals("ohyeahbrother")) {
                ...
                if (userInput5.toLowerCase().equals("yes")) {
                    main(args);
                } else {
                    System.out.println("1....2....3! IT'S OVER!");
                    return;
